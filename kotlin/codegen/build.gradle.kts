...
dependencies {
  ...
  shade("com.squareup:kotlinpoet-metadata:1.5.0")
  shade("com.squareup:kotlinpoet-metadata-specs:1.5.0")
  shade("com.squareup:kotlinpoet-classinspector-elements:1.5.0")
