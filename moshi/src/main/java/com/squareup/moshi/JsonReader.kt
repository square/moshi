...
public abstract class JsonReader : Closeable {
  ...
  @JvmField
  public var scopes: IntArray
  @JvmField
  public var pathNames: Array<String?>
  @JvmField
  public var pathIndices: IntArray

  /** True to accept non-spec compliant JSON.  */
  @JvmField
  protected var lenient: Boolean = false

  /** True to throw a [JsonDataException] on any attempt to call [.skipValue].  */
  @JvmField
  protected var failOnUnknown: Boolean = false
  ...
  // Package-private to control subclasses.
  internal constructor(copyFrom: JsonReader) {
  ...
  protected fun syntaxError(message: String): JsonEncodingException {
  ...
  protected fun typeMismatch(value: Any?, expected: Any): JsonDataException {
    return if (value == null) {
      JsonDataException("Expected $expected but was null at path ${getPath()}")
    } else {
      JsonDataException(
        "Expected "
          + expected
   ...
   */
  public class Options private constructor(@JvmField public val strings: Array<String>, @JvmField public val doubleQuoteSuffix: okio.Options) {
    ...
    public companion object {
      ...
      public fun of(vararg strings: String): Options {
        try {
          ...
          return Options(arrayOf(*strings).clone(), okio.Options.of(*result.filterNotNull().toTypedArray()))
        } catch (e: IOException) {
