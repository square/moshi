...
public sealed class JsonReader : Closeable {
  ...
  public fun syntaxError(message: String): JsonEncodingException {
    throw JsonEncodingException("$message at path $path")
  }

  public fun typeMismatch(value: Any?, expected: Any): JsonDataException {
    ...
    public companion object {
      ...
      public fun of(vararg strings: String): Options {
        return try {
          ...
          Options(strings.clone() as Array<String>, okio.Options.of(*result as Array<ByteString>))
        } catch (e: IOException) {
