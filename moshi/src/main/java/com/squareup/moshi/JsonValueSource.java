 ...
 *
 * <p>It implements {@link JsonReader#setLenient lenient parsing} and has no mechanism to enforce
 * strict parsing. If the input is not valid or lenient JSON the behavior of this source is
 * unspecified.
 */
final class JsonValueSource implements Source {
  ...
  public long read(Buffer sink, long byteCount) throws IOException {
    ...
    // If this stream has a prefix, consume it first.
    if (!prefix.exhausted()) {
