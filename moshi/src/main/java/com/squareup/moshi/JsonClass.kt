...
public annotation class JsonClass(
   ...
   *  * If generic, a second [Type[]][Type] parameter should be declared to accept type
   * arguments.
   *
   * Example for a class "CustomType":
   *
   * <pre>`class CustomTypeJsonAdapter(moshi: Moshi, types: Array<Type>) : JsonAdapter<CustomType>() {
   * // ...
   * }
  `</pre> *
   *
