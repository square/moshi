...
internal class JsonValueSource @JvmOverloads constructor(
   ...
   *  * We have some data to return and returning more would require reloading the buffer. We
  ...
  override fun read(sink: Buffer, byteCount: Long): Long {
    ...
    val result = Math.min(byteCount, limit)
  ...
  companion object {
    ...
    @JvmField
    val STATE_END_OF_JSON: ByteString = ByteString.EMPTY
  }
}
