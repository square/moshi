 ...
 *
 *  * **Java class fields**
 *  * **Kotlin properties** for use with `moshi-kotlin` or `moshi-kotlin-codegen`. This includes both properties declared in the constructor and
 * properties declared as members.
 *
 * Users of the [AutoValue: Moshi
 * Extension](https://github.com/rharter/auto-value-moshi) may also use this annotation on abstract getters.
 */
