...
public final class AsArrayJsonAdapterTest {
  ...
  @Test public void basicClassAdapter() throws Exception {
    ...
    assertThat(toJson).isEqualTo("[13,true]");

    BasicPizza fromJson = fromJson(BasicPizza.class, "[13,true]");
  ...
  @Test public void privateFields() throws Exception {
    ...
    assertThat(toJson).isEqualTo("[\"vodka\"]");

    PrivateFieldsPizza fromJson = fromJson(
        PrivateFieldsPizza.class, "[\"vodka\"]");
  ...
  @Test public void fieldsAreAlphabeticalAcrossFlattenedHierarchy() throws Exception {
    ...
    assertThat(toJson).isEqualTo("[4,5,6,7,8]");

    ExtendsBaseAbcde fromJson = fromJson(
        ExtendsBaseAbcde.class, "[4,5,6,7,8]");
  ...
  @Test public void fieldNameCollision() throws Exception {
    try {
      AsArrayJsonAdapter.FACTORY.create(ExtendsBaseA.class, NO_ANNOTATIONS, moshi);
      fail();
    } catch (IllegalArgumentException expected) {
      assertThat(expected).hasMessage("Conflicting fields:\n"
          + "    int com.squareup.moshi.AsArrayJsonAdapterTest$ExtendsBaseA.a\n"
          + "    int com.squareup.moshi.AsArrayJsonAdapterTest$BaseA.a");
    }
  }
  ...
  @Test public void jsonAnnotationNameCollision() throws Exception {
    try {
      AsArrayJsonAdapter.FACTORY.create(NameCollision.class, NO_ANNOTATIONS, moshi);
      fail();
    } catch (IllegalArgumentException expected) {
      assertThat(expected).hasMessage("Conflicting fields:\n"
          + "    java.lang.String com.squareup.moshi.AsArrayJsonAdapterTest$NameCollision.foo\n"
          + "    java.lang.String com.squareup.moshi.AsArrayJsonAdapterTest$NameCollision.bar");
    }
  }
  ...
  @Test public void fieldNameCollisionWithTransientFieldIsOkay() throws Exception {
    ...
    assertThat(toJson).isEqualTo("[11]");

    ExtendsTransientBaseA fromJson = fromJson(ExtendsTransientBaseA.class, "[11]");
  ...
  @Test public void magicConstructor() throws Exception {
    MagicConstructor fromJson = fromJson(MagicConstructor.class, "[8]");
  ...
  @Test public void nullFieldValues() throws Exception {
    ...
    NullFieldValue fromJson = fromJson(NullFieldValue.class, "[null]");
  ...
  @Test public void nonStaticNestedClassNotSupported() throws Exception {
    try {
      AsArrayJsonAdapter.FACTORY.create(NonStatic.class, NO_ANNOTATIONS, moshi);
      fail();
    } catch (IllegalArgumentException expected) {
      assertThat(expected).hasMessage("Cannot serialize non-static nested class "
          + "com.squareup.moshi.AsArrayJsonAdapterTest$NonStatic");
    }
  }
  ...
  @Test public void anonymousClassNotSupported() throws Exception {
    ...
    try {
      AsArrayJsonAdapter.FACTORY.create(c.getClass(), NO_ANNOTATIONS, moshi);
      fail();
    } catch (IllegalArgumentException expected) {
  ...
  @Test public void interfaceNotSupported() throws Exception {
    assertThat(AsArrayJsonAdapter.FACTORY.create(Runnable.class, NO_ANNOTATIONS, moshi)).isNull();
  }
  ...
  @Test public void abstractClassNotSupported() throws Exception {
    try {
      AsArrayJsonAdapter.FACTORY.create(Abstract.class, NO_ANNOTATIONS, moshi);
      fail();
    } catch (IllegalArgumentException expected) {
      assertThat(expected).hasMessage("Cannot serialize abstract class "
          + "com.squareup.moshi.AsArrayJsonAdapterTest$Abstract");
    }
  }
  ...
  @Test public void platformSuperclassProtectedFieldIsIncluded() throws Exception {
    ...
    assertThat(toJson).isEqualTo("[4,[5,6],2]");

    ExtendsPlatformClassWithProtectedField fromJson = fromJson(
        ExtendsPlatformClassWithProtectedField.class, "[4,[5,6],2]");
    assertThat(fromJson.a).isEqualTo(4);
  ...
  private <T> String toJson(Class<T> type, T value) throws IOException {
    @SuppressWarnings("unchecked") // Factory.create returns an adapter that matches its argument.
        JsonAdapter<T> jsonAdapter = (JsonAdapter<T>) AsArrayJsonAdapter.FACTORY.create(
