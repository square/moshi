...
public final class PromoteNameToValueTest {
  ...
  public void writerBooleanValue() throws Exception {
    ...
    try {
      ...
      assertThat(e).hasMessageThat().isEqualTo("Boolean cannot be used as a map key in JSON at path $.");
    }
    writer.value("true");
  ...
  public void writerNullValue() throws Exception {
    ...
    try {
      ...
      assertThat(e).hasMessageThat().isEqualTo("null cannot be used as a map key in JSON at path $.");
    }
    writer.value("null");
  ...
  public void writerSourceValueFails() throws Exception {
    ...
    try {
      ...
      assertThat(expected)
          .hasMessageThat().isEqualTo("BufferedSource cannot be used as a map key in JSON at path $.");
    }
    writer.value("a");
  ...
  public void writerValueSinkFails() throws Exception {
    ...
    try {
      ...
      assertThat(expected)
          .hasMessageThat().isEqualTo("BufferedSink cannot be used as a map key in JSON at path $.");
    }
    writer.value("a");
    writer.value("a value");
    writer.endObject();
